...
CGIS_SymEleCircle::CGIS_SymEleCircle(void)
{
	r=0;
	m_IsFill=false;
	m_LineWidth=1;
	...
	m_SymEleType="CGIS_SymEleCircle";
}
...
bool CGIS_SymEleCircle::Draw(CDC *pDc)
{
...
bool CGIS_SymEleCircle::Read(CFile *pFile)
{
	return false;
}

bool CGIS_SymEleCircle::Save(CFile *pFile)
{
	return false;
}